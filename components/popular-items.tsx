...
const PopularItems = ({ products }: PopularItemsProps) => {
  return (
    <>
      <section
        id="popular"
        className="space-y-6 bg-slate-50/70 py-8 md:py-12 lg:pt-20 lg:pb-18"
      >
          ...
          <Carousel>
            ...
            <CarouselPrevious
              className={cn(
                ...
                'rounded-full hover:text-white shadow-lg absolute lg:-top-12 left-[13rem] lg:left-[80rem]'
              )}
            />
            <CarouselNext
              className={cn(
                ...
                'rounded-full hover:text-white shadow-lg absolute lg:-top-12 -right-7 lg:-right-6'
              )}
            />
          </Carousel>
        </div>
